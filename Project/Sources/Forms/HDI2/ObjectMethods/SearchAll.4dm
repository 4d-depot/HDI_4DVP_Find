...
Form:C1466.findResults.range:=VP Find($range; Form:C1466.searchValue; New object:C1471("all"; True:C214; "target"; $target; "flags"; $flags; "order"; $order))
...
Else 
	...
	ALERT:C41(String:C10(Form:C1466.findResults.length())+" results found")
End if 
